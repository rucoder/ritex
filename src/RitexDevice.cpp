...
static setting_t all_Settings[] = {
	{"Частота вращения", " об/мин", 31, 0, 2, true, 0, false},
	{"Ток ВД при перегрузе", " А", 32, 0, 0, true, 0, false},
	{"Защита по перегрузу", " %", 33, 0, 0, true, 0, false},
	{"Время блокировки защиты", " сек", 34, 0, 0, true, 0, false},
	{"Время блокировки АПВ", " мин", 35, 0, 0, true, 0, false},
	{"Количество перезапусков", "", 36, 0, true, 0, false},
	{"Время, в течение которого разрешены перезапуски", " мин", 37, 0, 0, true, 0, false},
	{"Ток ВД при недогрузе", " А", 38, 0, 0, true, 0, false},
	{"Защита по недогрузу", " %", 39, 0, 0, true, 0, false},
	{"Время блокировки защиты", " сек", 40, 0, 0, true, 0, false},
	{"Время блокировки АПВ", " мин", 41, 0, 0, true, 0, false},
	{"Куст", " №", 42, 0, 0, true, 0, false},
	{"Скважина", " №", 43, 0, 0, true, 0, false},
	{"Пароль", "", 44, 0, true, 0, false},
	{"Служебный режим", "", 45, 0, true, 0, false},
	{"Время работы", " мин", 46, 0, 0, true, 0, false},
	{"Время паузы", " мин", 47, 0, 0, true, 0, false},
	{"Шаг регистрации параметров", " сек", 48, 0, 0, true, 0, false},
	{"Текущее время (часы", " минуты)", 49, 0, 0, true, 0, false},
	{"Текущая дата (число", " месяц)", 50, 0, 0, true, 0, false},
	{"Текущая дата (год)", "", 51, 0, true, 0, false},
	{"Напряжение вторичной обмотки трансформатора", " В", 52, 0, 0, true, 0, false},
	{"Время блокировки запуска после включения питания", " мин", 53, 0, 0, true, 0, false},
	{"Защита по Rиз: 0 – включена", " 1 – выключена", 54, 0, 0, true, 0, false},
